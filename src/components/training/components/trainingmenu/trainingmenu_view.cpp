...
void TrainingMenu::drawModality() {
    ...
    // body
    DrawRectangle((renderW/3)-20, 0, 15, renderH/2, BLACK);//outerborder up
    DrawRectangle((renderW/3)-15, 0, 10, (renderH/2)-5, RED);//innerborder up

    DrawRectangle(((renderW/3)*2)+5, renderH/2, 15, renderH/2, BLACK);//outerborder down
    DrawRectangle(((renderW/3)*2)+5, (renderH/2)+5, 10, (renderH/2)-5, RED);//innerborder down
